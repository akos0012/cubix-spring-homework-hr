...
public class InitDbService {
    ...
    public void insertTestData() {
        ...
        Employee employee1 = new Employee("Alice Johnson", 8500, LocalDateTime.of(1999, 8, 12, 8, 0), "alice", passwordEncoder.encode("pass"));
        employee1.setPosition(softwareEngineer);
        Employee employee2 = new Employee("Bob Smith", 11000, LocalDateTime.of(1985, 5, 20, 8, 0), "bob", passwordEncoder.encode("pass"));
        ...
        Employee employee3 = new Employee("Charlie Brown", 5000, LocalDateTime.of(2015, 9, 3, 10, 30), "charlie", passwordEncoder.encode("pass"));
        employee3.setPosition(marketingSpecialist);
        Employee employee4 = new Employee("Diana Prince", 7000, LocalDateTime.of(2010, 11, 18, 9, 0), "diana", passwordEncoder.encode("pass"));
        employee4.setPosition(marketingSpecialist);
        Employee employee5 = new Employee("Dwayne Johnson", 20000, LocalDateTime.of(1972, 5, 2, 0, 0), "theRock", passwordEncoder.encode("pass"));
        employee5.setPosition(rockAnalyst);
        employee5.setRoles(Set.of("user", "admin"));


        employeeRepository.save(employee5);

        employee3.setManager(employee5);
        employee4.setManager(employee5);
